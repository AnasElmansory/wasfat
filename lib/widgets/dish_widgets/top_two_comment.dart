    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          if (!ifNoComment) WatchAllComment(dish: dish),
        ],
      ),
    );
  }
...
class WatchAllComment extends StatelessWidget {
  final Dish dish;

  const WatchAllComment({Key? key, required this.dish}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return InkWell(
